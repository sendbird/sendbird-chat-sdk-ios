...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/sendbird/sendbird-chat-sdk-ios/releases/download/0.0.100/SendbirdAuth.zip", :sha1 => "f6293edb7fa888cf4cd02908250daf263ecae432" }
  s.requires_arc = true
  s.platform = :ios, '13.0'
