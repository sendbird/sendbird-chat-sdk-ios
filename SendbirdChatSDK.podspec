...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/sendbird/sendbird-chat-sdk-ios/releases/download/4.21.4/SendbirdChatSDK.zip", :sha1 => "b592d0840ef018d4e111adc77db8a4c97b50b67d" }
  s.requires_arc = true
  s.platform = :ios, '12.0'
