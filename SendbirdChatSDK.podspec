...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/sendbird/sendbird-chat-sdk-ios/releases/download/1.0.100/SendbirdChatSDK.zip", :sha1 => "409bdb97e774a2c8ff70b4d7df298eb542f7193e" }
  s.requires_arc = true
  s.platform = :ios, '13.0'
