...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/sendbird/sendbird-chat-sdk-ios/releases/download/v4.0.9/SendbirdChatSDK.zip", :sha1 => "815d56a78442cd44dadbd57175ea8b6dc2f765b9" }
  s.requires_arc = true
  s.platform = :ios, '9.0'
