...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/sendbird/sendbird-chat-sdk-ios/releases/download/4.32.0/SendbirdChatSDK.zip", :sha1 => "1fcbbce42e1b2a60bad994b848305cb630fa1cef" }
  s.requires_arc = true
  s.platform = :ios, '13.0'
