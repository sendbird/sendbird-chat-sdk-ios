...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/sendbird/sendbird-chat-sdk-ios/releases/download/4.27.1/SendbirdChatSDK.zip", :sha1 => "ccc3a394d85a44fe7e6487083a3a8a92fca9af3a" }
  s.requires_arc = true
  s.platform = :ios, '13.0'
