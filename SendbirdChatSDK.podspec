...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/sendbird/sendbird-chat-sdk-ios/releases/download/4.30.0/SendbirdChatSDK.zip", :sha1 => "cefac88827586b1e723002c4b9a857dd52d8cf98" }
  s.requires_arc = true
  s.platform = :ios, '13.0'
