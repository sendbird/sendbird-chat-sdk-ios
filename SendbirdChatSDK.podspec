...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/sendbird/sendbird-chat-sdk-ios/releases/download/4.19.7/SendbirdChatSDK.zip", :sha1 => "f8be5bb27ce277258f76d629156bc7b953737def" }
  s.requires_arc = true
  s.platform = :ios, '12.0'
